          ...
          {props.drafts.map((post) => (
            <>
              <div className="relative mb-10">
                <a className="absolute inset-0 z-10 w-3/4 bg-white text-center flex flex-col mx-auto items-center justify-center opacity-0 hover:opacity-100 bg-yellow-ecf bg-opacity-95 rounded duration-300 cursor-pointer text-5xl" onClick={() => Router.push("/p/[id]", `/p/${post.id}`)}>
                  Voir le menu
                </a>
