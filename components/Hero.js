        ...
        <div id="contact" className="pt-20 h-full bg-black">
          ...
          <div className="text-center pt-12 pb-24 bg-black">
            ...
            <p className="text-white text-xl mb-10">
              Le Quai Antique Restaurant & Chambres d’hôtes, 59 Rue Commandant Joseph Perceval
            </p>
            <p className="text-white text-xl mb-10">
              <a href="https://goo.gl/maps/MkVNF4E8X6pc9x157">73000 Chambéry</a>, <a href="tel:0652787143">06 52 78 71 43, </a><a href="mailto:restaurant@lequaiantique.fr">restaurant@lequaiantique.fr</a>
            </p>
            <p className="text-white text-xl pb-10">
              Horaires: du lundi au vendredi de 07:00 à 15:00 et de 18:00 à 23:00
            </p>
            <a className="text-red-ecf text-xl hover:underline" href="mentions-legales">Mentions Légales</a>
          </div>
        </div>
      </div>
    </div>
